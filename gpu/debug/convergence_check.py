...
print(get_similarity(distributions[0], distributions[1], top_words, word_tolerance))
print(get_similarity(distributions[0], distributions[2], top_words, word_tolerance))
print(get_similarity(distributions[0], distributions[3], top_words, word_tolerance))
print(get_similarity(distributions[0], distributions[4], top_words, word_tolerance))