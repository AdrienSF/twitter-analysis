...
k = 1
alpha_0 = 0.1
a, phi, _, _ = get_phi(k, 100, 500, 10,alpha_val=alpha_0/k)
...
t = TLDA(k,n_senti=1, alpha_0= alpha_0, n_iter_train=10000,
        n_iter_test=150, batch_size=5000, # increase train, 2000
            learning_rate=learning_rate,theta=1)
...
print('argsort phi:',np.argsort(nphi[0,0])[-10:])
print('argsort factors',np.argsort(factors[0])[-10:])
